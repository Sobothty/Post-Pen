                ...
                <nav class="w-4/6">
                    <ul class="hidden lg:flex justify-between items-center">
                        <div class="flex gap-10">
                            <li><a href="/src/html/about.html" class="hover:text-[#FF9067]">About</a></li>
                            <!-- Dropdown: Education -->
                            <li class="relative">
                                ...
                                <ul id="education-dropdown" class="absolute left-0 mt-2 w-48 p-2 bg-white border border-gray-200 rounded shadow-lg hidden">
                                    <li><a href="/src/html/general.html" class="flex items-center gap-2 px-4 py-2 text-gray-700 hover:bg-[#F0EFEF]"><i class="fa-solid fa-book"></i>General</a></li>
                                    <li><a href="/src/html/soft-skill.html" class="flex items-center gap-2 px-4 py-2 text-gray-700 hover:bg-[#F0EFEF]"><i class="fa-solid fa-code-branch"></i>Soft-skills</a></li>
                                </ul>
                            </li>
                            <!-- Dropdown: Technology -->
                            <li class="relative">
                                ...
                                <ul id="technology-dropdown" class="absolute left-0 mt-2 w-48 p-2 bg-white border border-gray-200 rounded shadow-lg hidden">
                                    <li><a href="/src/html/ai.html" class="flex items-center gap-2 px-4 py-2 text-gray-700 hover:bg-[#F0EFEF]"><i class="fa-solid fa-hexagon-nodes"></i>AI</a></li>
                                    <li><a href="/src/html/newtech.html" class="flex items-center gap-2 px-4 py-2 text-gray-700 hover:bg-[#F0EFEF]"><i class="fa-solid fa-code-branch"></i>New Technology</a></li>
                                </ul>
                            </li>
                        </div>
                        <div class="flex items-center gap-4">
                            ...
                            <li>
                                <a href="/src/html/login.html" class="bg-[#ff7f50] text-white px-4 py-2 rounded hover:bg-[#FF9067] flex items-center gap-2">
                    ...
                    <ul id="mobile-menu" class="absolute top-16 left-0 w-full bg-white p-4 shadow-md hidden lg:hidden">
                        <li><a href="/src/html/about.html" class="hover:text-[#FF9067] block py-2">About</a></li>
                        <li>
